...
- Cart → checkout (`CheckoutModal.vue`, pre-filled from the saved profile; Cash on Delivery or Card, the latter redirecting to Stripe hosted checkout and back to `/checkout/return`) → order confirmation
